...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <form id="postEventForm" action="submit_event.php" method="POST" class="bg-white rounded-xl shadow-md p-6">
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="url" id="image" name="image" placeholder="https://example.com/image.jpg" class="mt-1 w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
